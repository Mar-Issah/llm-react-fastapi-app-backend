...
def generate_challenge_with_ai(difficulty: str) -> Dict[str, Any]:
    ...
    The question should be appropriate for the specified difficulty level. Do not repeat question patterns or topics too often. Vary the format, structure, and concepts.
Use randomization in variable names, functions, and data samples.
If similar questions were recently asked, generate a completely different one.

    For easy questions: Focus on basic syntax, simple operations, true/false, list comprehensions or common programming concepts.
